...
def merge_sort_v2(arr):
	...
	mid = len(arr) // 2
	left = merge_sort_v2(arr[:mid])
	right = merge_sort_v2(arr[mid:])
...
if __name__ == "__main__":
	...
	# Merge Sort
	merge_sort_v2ed = merge_sort_v2(sample_data.copy())
	print("Merge Sort:", merge_sort_v2ed)
